...
export function Footer() {
  return (
    <footer className="border-t border-line bg-white px-6 pt-16 pb-12 md:px-12 lg:px-[120px] lg:pt-24">
        ...
        <div className="flex flex-col justify-between gap-12 lg:flex-row lg:items-start">
          <div className="flex w-full max-w-[401px] flex-col gap-4">
            <Link href="/" className="flex items-center gap-2">
              <Icon name="logo-mark-footer" size={24} />
              <span className="text-[18px] font-extrabold text-ink">
                DuetSpace
              </span>
            </Link>
            <p className="text-[13px] leading-[1.5] text-body">
              Build together. Launch anywhere. DuetSpace gives every
              collaboration a shared home — from the first agreement to the final
              product.
            </p>
          </div>
          ...
          <div className="flex flex-wrap gap-12 lg:gap-16">
            {LINK_COLUMNS.map((column) => (
              ...
              >
                <p className="text-[12px] font-bold tracking-[0.01em] text-accent uppercase">
                  {column.heading}
                </p>
